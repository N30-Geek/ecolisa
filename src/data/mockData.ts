...
export const mockStudents: Eleve[] = [
  ...
  },
  {
    ...
    territoireCommune: 'Commune de Lubumbashi',
    chefferieSecteur: 'Secteur de Kipushi',
    groupement: 'Groupement Bakwanga-Sud',
    village: 'Village Mbuyi-Centre',
    adressePhysique: 'N° 12, Av. Kasavubu, Q. Kampemba, Lubumbashi',
    statut: 'ACTIF',
    classId: 'cls-4',
    nomClasse: '3ème Math-Physique',
  ...
  },
  {
    ...
    lieuNaissance: 'Goma',
    province: 'Nord-Kivu',
    provinceOrigine: 'Nord-Kivu',
    territoireCommune: 'Territoire de Beni',
    chefferieSecteur: 'Chefferie des Bashu',
    groupement: 'Groupement Isale-Vuhovi',
    village: 'Village Musienene',
    adressePhysique: 'N° 88, Av. Karisimbi, Q. Les Volcans, Goma',
    statut: 'ACTIF',
    classId: 'cls-3',
    nomClasse: '8ème CTEB',
  ...
  },
  {
    ...
    provinceOrigine: 'Kongo-Central',
    territoireCommune: 'Commune de Matadi',
    chefferieSecteur: 'Secteur de Mfuma',
    groupement: 'Groupement Nsona-Nkanu',
    village: 'Village Nzanza-Nord',
    adressePhysique: 'N° 24, Av. Bel Air, Q. Mvuzi, Matadi',
    statut: 'ACTIF',
    classId: 'cls-5',
